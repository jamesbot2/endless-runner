...
function defaultGameData() {
  return {
    coins: 0, credits: 0, totalCoins: 0,
    equippedAbility: 0, ownedAbilities: [0],
    ownedCharacters: [0], selectedCharacter: 0,
    maxDistance: 0, maxEasy: 0, maxMedium: 0, maxHard: 0,
    maxEasyAbility: 0, maxMediumAbility: 0, maxHardAbility: 0,
    runCount: 0, highScore: 0,
  };
}
...
function normalizeGameData(g) {
  ...
  return {
    ...
    ownedCharacters: Array.isArray(g.ownedCharacters) ? g.ownedCharacters : [0],
    selectedCharacter: g.selectedCharacter || 0,
